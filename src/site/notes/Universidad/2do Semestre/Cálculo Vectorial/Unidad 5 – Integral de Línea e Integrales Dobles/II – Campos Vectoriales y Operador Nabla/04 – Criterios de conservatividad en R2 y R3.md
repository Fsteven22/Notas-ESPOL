---
{"dg-publish":true,"permalink":"/universidad/2do-semestre/calculo-vectorial/unidad-5-integral-de-linea-e-integrales-dobles/ii-campos-vectoriales-y-operador-nabla/04-criterios-de-conservatividad-en-r2-y-r3/","dg-note-properties":{}}
---
...
>         |  P      Q      R   |
> 
>       = \hat{i}(∂R/∂y - ∂Q/∂z) - \hat{j}(∂R/∂x - ∂P/∂z) + \hat{k}(∂Q/∂x - ∂P/∂y)
> ```
> 
...
>     B --> C[Componente \hat{i}:<br/>∂R/∂y - ∂Q/∂z]
>     B --> D[Componente \hat{j}:<br/>∂P/∂z - ∂R/∂x]
>     B --> E[Componente \hat{k}:<br/>∂Q/∂x - ∂P/∂y]
>     
>     C --> F{¿Todas = 0?}
>     D --> F
>     E --> F
...
> Componente \hat{i}: ∂R/∂y - ∂Q/∂z = x - x = 0 ✓
> Componente \hat{j}: ∂P/∂z - ∂R/∂x = y - y = 0 ✓
> Componente \hat{k}: ∂Q/∂x - ∂P/∂y = z - z = 0 ✓
> 
> Paso 4: Conclusión
> ∇ × F = ⟨0, 0, 0⟩ = 0
> 
...
> En ℝ²: ∂P/∂y = ∂Q/∂x
> 
> Es equivalente a la componente \hat{k} del rotacional en ℝ³:
> (∇ × F)·\hat{k} = ∂Q/∂x - ∂P/∂y = 0
> 
...
> ```
> Componente \hat{i}: ∂R/∂y - ∂Q/∂z = x² - x² = 0 ✓
> Componente \hat{j}: ∂P/∂z - ∂R/∂x = 2xy - 2xy = 0 ✓
> Componente \hat{k}: ∂Q/∂x - ∂P/∂y = 2xz - 2xz = 0 ✓
> 
> ∇ × F = ⟨0, 0, 0⟩ = 0
> 
> F ES conservativo
...
> **6. Aplicación física**
> ```
> Campo gravitacional: F = -GMm/r² \hat{r}
> 
