---
{"dg-publish":true,"permalink":"/universidad/1er-semestre/ingles-i-b1-b2/unit-12-life-s-little-lessons/02-grammar-and-examples-phrasal-verbs-unreal-conditionals/","dg-note-properties":{}}
---
...
```mermaid
mindmap
  root((Unit 12<br/>Grammar))
    Indefinite Pronouns
      SOME-
        someone/somebody
        something
        somewhere
        Use: affirmative, offers
      ANY-
        anyone/anybody
        anything
        anywhere
        Use: questions, negatives
      NO-
        no one/nobody
        nothing
        nowhere
        Use: negative meaning
      EVERY-
        everyone/everybody
        everything
        everywhere
