---
{"dg-publish":true,"permalink":"/universidad/1er-semestre/ingles-i-b1-b2/unit-10-why-we-buy/01-vocabulary-and-use-materials-production-and-distribution/","dg-note-properties":{}}
---
...
```mermaid
graph LR
    A[Product] --> B{What is it<br/>made of?}
    A --> C{How was it<br/>produced?}
    A --> D{How did it<br/>get here?}
