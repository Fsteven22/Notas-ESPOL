---
{"dg-publish":true,"permalink":"/universidad/3er-semestre/fundamentos-de-electricidad-y-sistemas-digitales/teorico/unidad-1-electricidad-y-circuitos/03-elementos-basicos-de-un-circuito-electrico/","dg-note-properties":{}}
---
...
>
> | Elemento | Símbolo US (ANSI) | Símbolo EU (IEC) |
> |---|---|---|
> | **Resistencia** | Zigzag /\/\/\ | Rectángulo □ |
> | **Capacitor** | Dos líneas paralelas ⊣⊢ | Dos líneas paralelas ⊣⊢ (igual) |
> | **Inductor** | Semicírculos en serie ⌇ | Rectángulo □ o espiral |
> | **Fuente de voltaje** | Círculo con +/− | Círculo con +/− (igual) |
> | **Tierra** | Líneas decrecientes ⏚ | Líneas decrecientes ⏚ (igual) |
>
> > ⚠️ En esta materia se usará principalmente la simbología **US (ANSI)** por ser la que aparece en los libros de texto de referencia (Boylestad, Alexander & Sadiku, Hambley).
...
> ```
>
> | Elemento | Descripción | Estado por defecto | Acción |
> |---|---|---|---|
> | **Interruptor** | Abre o cierra el circuito de forma permanente | Depende de posición | Manual |
> | **Pulsador NA** | Normalmente Abierto — cierra mientras se presiona | Abierto (sin corriente) | Al presionar: cierra |
> | **Pulsador NC** | Normalmente Cerrado — abre mientras se presiona | Cerrado (con corriente) | Al presionar: abre |
> | **Relé** | Interruptor controlado por una bobina electromagnética | Abierto (sin bobina energizada) | Al energizar bobina: cierra |
>
> **¿Cómo funciona un relé?**
>
> > Una pequeña corriente de control energiza la **bobina** del relé, generando un campo magnético que atrae un contacto metálico y cierra (o abre) un circuito de mayor potencia. Permite controlar cargas grandes con señales pequeñas.
>
> ```mermaid
> graph LR
